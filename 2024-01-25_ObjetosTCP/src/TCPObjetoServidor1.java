...
/**
 * El programa servidor crea un objeto y lo envía al cliente El cliente cambia
 * los valores y se los devuelve al servidor
 */
...
public class TCPObjetoServidor1 {
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		// el socket recibe y envia byteStream mediante getInputStream()
		// getOutputStream()

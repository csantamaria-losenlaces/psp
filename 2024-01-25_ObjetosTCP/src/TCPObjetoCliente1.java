...
/**
 * El programa cliente recibe un objeto persona del servidor Cambia los datos y
 * los reenv�a de nuevo.
 * 
 * @author juanjo
 *
 */
...
public class TCPObjetoCliente1 {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		String host = "DESKTOP-H9HTCEI"; // poner la direccion IP o el nombre de equipo
		int puerto = 6000;

public class Cliente implements Runnable {
	...
	public void run() {
		...
		// Compra entradas
		concierto.comprarEntradas(numEntradasSolicitadas, "Cliente " + Thread.currentThread().getName() + " solicita " + 
				numEntradasSolicitadas + " entrada/s");
		...
		case 1:
			...
			if (probabilidad >= 90 && probabilidad <= 95) {
				concierto.devolverEntradas(1, "Cliente " + Thread.currentThread().getName() + " devuelve 1 entrada");
			}
			break;
		case 2:
			...
			if (probabilidad >= 96 && probabilidad <= 98) {
				...
				concierto.devolverEntradas(numEntradasDevueltas, "Cliente " + Thread.currentThread().getName() + " devuelve " + numEntradasDevueltas + " entrada/s");
			}
			break;
		case 3:
